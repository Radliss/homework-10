...
const result = function calculateDifference(ab, cd){
console.log(ab - cd);
};
...
const total = function calculateProduct (ef, gh){
console.log(ef * gh);
};
...
const thisYear = 2023;
function calculateYearsSinceLastOlympics(lastOlympicsYear, thisYear) {
	return lastOlympicsYear - thisYear;
}
...
const thisYear2 = 2023;
function calculateAge(thisYear2, friendYearOfBirth) {
	console.log(thisYear2 - friendYearOfBirth)
}
...
let thisYear3 = 2023;
function calculateMyAge(myYearOfBirth) {
	return thisYear3 - myYearOfBirth;
}
console.log(calculateMyAge(1980));
